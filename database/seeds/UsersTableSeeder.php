...
//        $users['famoon'] = [ 'first_name' => "Foad", 'last_name' => "Amoon", 'supervisor_id'=>1 ,'title' => "Director", 'email' => "famoon@vxchnge.com", 'role' => 1, 'department' => 1, 'password' => bcrypt("test"), 'api_token' => Str::random(60)] ;
        $users['prosaTest'] = [ 'first_name' => "Pablo", 'last_name' => "Rosa", 'supervisor_id'=>0 ,'title' => "Developer", 'email' => "prosa@yahoo.com", 'role' => 1, 'department' => 1, 'password' => bcrypt("test"), 'api_token' => Str::random(60),] ;
        ...
        $users['mike'] = [ 'first_name' => "Mike", 'last_name' => "Burn", 'supervisor_id'=>1 ,'title' => "Developer", 'email' => "prosa@vxchnge.com", 'role' => 1, 'department' => 1, 'password' => bcrypt("test"), 'api_token' => Str::random(60),] ;
