...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $users['amarashi'] = [ 'first_name' => "Ali", 'last_name' => "Marashi", 'supervisor_id'=>0 ,'title' => "VP", 'email' => "aseal@vxchnge.com", 'role' => 1, 'department' => 1, 'password' => bcrypt("test"), 'api_token' => Str::random(60)] ;
